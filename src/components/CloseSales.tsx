...
const mockActiveShifts: CashierShift[] = JSON.parse(localStorage.getItem('pos_cash_sales') || '[]');
const mockReconciliationHistory: ReconciliationRecord[] = JSON.parse(localStorage.getItem('pos_reconciliation_history') || '[]');
